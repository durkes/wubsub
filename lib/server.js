...
module.exports = function ({ port = 3000, heartbeat = 30000 } = {}) {
    ...
    // a client pointed at this server needs the same heartbeat value
    const heartbeatTimer = heartbeat > 0 ? setInterval(() => {
